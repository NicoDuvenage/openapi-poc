...
/**
 * Test for /webhooks/reject-expired-tokens
 */
Test('/webhooks/reject-expired-tokens', function (t) {
     ...
     * responses: default
     */
    t.test('test postWebhooksRejectexpiredtokens post operation', async function (t) {
