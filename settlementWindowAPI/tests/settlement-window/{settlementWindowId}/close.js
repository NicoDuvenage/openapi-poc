...
/**
 * Test for /settlement-window/{settlementWindowId}/close
 */
Test('/settlement-window/{settlementWindowId}/close', function (t) {
    ...
    t.test('test closeSettlementWindow post operation', async function (t) {
        ...
        const requests = new Promise((resolve, reject) => {
            Mockgen().requests({
                path: '/settlement-window/{settlementWindowId}/close',
                operation: 'post'
            }, function (error, mock) {
