...
/**
 * Test for /settlementWindow/{settlementWindowId}
 */
Test('/settlementWindow/{settlementWindowId}', function (t) {
     ...
     */
    t.test('test getSettlementWindowRecord get operation', async function (t) {
        ...
        await InitServer({port: 81}).then(async (server) => {
            const requests = new Promise((resolve, reject) => {
                Mockgen().requests({
                    path: '/settlementWindow/{settlementWindowId}',
                    operation: 'get',
                    headers: {
